...
interface ChartProps {
  ...
  title: string
  description?: string
  dataKey: string // Key for the data point value (e.g., 'price')
  xAxisDataKey: string // Key for the x-axis (e.g., 'timestamp')
...
export function Chart({
  ...
  dataKey,
  xAxisDataKey,
  tooltipFormatter = (value) => [formatPrice(value), "Price"],
        ...
        <div className="h-[300px] w-full">
          <ResponsiveContainer width="100%" height="100%">
            <LineChart data={data}>
              ...
              />
              <YAxis tickFormatter={(value) => formatPrice(value)} className="text-sm text-muted-foreground" />
              <Tooltip
